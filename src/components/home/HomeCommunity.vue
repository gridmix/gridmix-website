<template>
  <Section>
  	<h2 class="text-center mb-x2">Gridmix Sponsors</h2>
    <div class="grid-cols container container-md grid-cols--2">
    	<Card class="sponsor text-center">
	      ...
	      <p>Thanks to <a href="https://netlify.com"  rel="noopener" target="_blank">Netlify</a> for sponsoring Gridmix hosting infrastructure.</p>
    	</Card>
      <Card class="sponsor text-center">
