...
## Deploying your Gridmix Website to Vercel

To deploy your Gridmix app with a [Vercel for Git Integration](https://vercel.com/docs/git-integrations), push your code to a repository on GitHub, GitLab, or Bitbucket.
...
Once deployed, you will get a URL to see your app live, such as the following: <https://gridmix.now-examples.now.sh>.
