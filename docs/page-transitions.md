...
Gridmix is mounting & unmounting the whole layout on route change. This happens because of how Gridmix deals with [Layouts](/docs/layouts/). Layouts are just wrapper components per page. This means, by default, it's only possible to have **Enter transitions**.
